...
<!-- BLOG-POST-LIST:START -->- [Why Your Next Great AI Bug Fix Won’t Come from a Human](https://saurabhshukla.com/blog/why-your-next-great-ai-bug-fix-wont-come-from-a-human) — *Jun 12, 2026*- [Laravel Brain: Visualize Your Laravel App Architecture](https://saurabhshukla.com/blog/laravel-brain-visualize-your-laravel-app-architecture) — *Jun 07, 2026*- [Semantic Vector Search via Eloquent with PostgreSQL](https://saurabhshukla.com/blog/semantic-vector-search-via-eloquent-with-postgresql) — *Jun 07, 2026*- [Building Multi-Step AI Agents with Laravel AI SDK](https://saurabhshukla.com/blog/building-multi-step-ai-agents-with-laravel-ai-sdk) — *Jun 05, 2026*- [From Coder to Conductor: Surviving AI-Generated Code](https://saurabhshukla.com/blog/from-coder-to-conductor-surviving-ai-generated-code) — *Jun 04, 2026*<!-- BLOG-POST-LIST:END -->
